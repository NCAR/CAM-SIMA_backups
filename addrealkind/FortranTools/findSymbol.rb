...
#   generated.  
#
#   First install findsymbol_app using install.rb.  
#   Then type "ruby findsymbol -h" for command-line options.  
#
#
# Assumptions:  
...
END_OF_COMMENTS
            ...
            matching_symbols.each do |sym|
              if (sym =~ /#{@symbol}/i) then
                ...
                ios.print "        USE #{@old_module}, #{new_name} => #{sym}\n"
              else
                # handle "operator", "assignment", etc.
                ios.print "        USE #{@old_module}, #{sym}\n"
              end
            end
