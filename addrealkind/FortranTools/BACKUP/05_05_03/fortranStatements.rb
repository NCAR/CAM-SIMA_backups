...
#  end
  ...
  # returns array of indices or empty array
  #
  # recursive
  #
  def find_cast_insertion(str, startofline)
#print"DEBUG:  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
#print"DEBUG:  begin find_cast_insertion, str = <<#{str}>>, startofline = #{startofline}\n"
#print"DEBUG:                                     0123456789012345678901234567890123456789\n"
    ret = []
    offset = 0
    while (possible_cast = str.index(/(REAL|CMPLX)(\s*)\(/, offset))
#print"DEBUG:  =============================================\n"
#print"DEBUG:  offset = <<#{offset}>>\n"
#print"DEBUG:  possible_cast = <<#{possible_cast}>>\n"
      pre_match = $`.dup
...
#print"DEBUG:  args.close_parens_index = <<#{args.close_parens_index}>>\n"
          ret << args.close_parens_index
        end
      end
      arg_str = args.get_arg_str
#print"DEBUG:  arg_str = <<#{arg_str}>>\n"
      arg_str_offset = args.open_parens_index + 1
#print"DEBUG:  arg_str_offset = <<#{arg_str_offset}>>\n"
      # recurse
#$$$here...  put limit on recursion depth?  
      argIndices = find_cast_insertion(arg_str, false)
#print"DEBUG:  before shift, argIndices = <<#{argIndices.join(" ")}>>\n"
#print"DEBUG:  shifting argIndices by <<#{arg_str_offset}>>\n"
      argIndices.collect! { |indx| indx = indx + arg_str_offset }
#print"DEBUG:  after shift, argIndices = <<#{argIndices.join(" ")}>>\n"
#print"DEBUG:  BEFORE +, ret = <<#{ret.join(",")}>>\n"
      ret = ret + argIndices
#print"DEBUG:  AFTER +, ret = <<#{ret.join(",")}>>\n"
