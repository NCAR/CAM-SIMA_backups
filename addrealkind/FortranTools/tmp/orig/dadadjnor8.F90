...
!
   ...
   real, intent(in) :: pmid(pcols,pver)   ! pressure at model levels
   real, intent(in) :: pint(pcols,pverp)  ! pressure at model interfaces
   real, intent(in) :: pdel(pcols,pver)   ! vertical delta-p

!
! Input/output arguments
!
   real, intent(inout) :: t(pcols,pver)      ! temperature (K)
   real, intent(inout) :: q(pcols,pver)      ! specific humidity
!
!---------------------------Local workspace-----------------------------
!
   ...
   real c1dad(pver)        ! intermediate constant
   real c2dad(pver)        ! intermediate constant
   real c3dad(pver)        ! intermediate constant
   real c4dad(pver)        ! intermediate constant
