...
!          property values. \!          "string" - prints {\tt timeinterval}'s value in ISO 8601 format
...
!                     {\tt ESMF\_TimeIntervalGet(..., timeString= , ...)} \!          "string isofrac" - prints {\tt timeinterval}'s value in strict
...
!                     {\tt ESMF\_TimeIntervalGet(..., timeStringISOFrac= , ...)} \!     \item[{[rc]}]
!          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
!     \end{description}
!
!EOP
