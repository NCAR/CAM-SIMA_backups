! $Id: ESMF_Time.F90,v 1.81.2.1 2005/02/08 23:46:08 eschwab Exp $
!
...
!     \item[{[options]}]
!          Print options. If none specified, prints all Time property values. \!          "string" - prints {\tt time}'s value in ISO 8601 format for all units
...
!                     See also method {\tt ESMF\_TimeGet(..., timeString= , ...)} \!          "string isofrac" - prints {\tt time}'s value in strict ISO 8601
...
!                     {\tt ESMF\_TimeGet(..., timeStringISOFrac= , ...)} \!     \item[{[rc]}]
!          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
!     \end{description}
!
!EOP
...
!            values. \!          "calendar" - validate only the {\tt time}'s calendar. \!          "timezone" - validate only the {\tt time}'s timezone. \!     \item[{[rc]}]
!          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
!     \end{description}
!
!EOP
