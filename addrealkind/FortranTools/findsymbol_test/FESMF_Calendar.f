...
!                             values. \!          "calendartype"   - print the calendar's type 
!                               (e.g. ESMF\_CAL\_GREGORIAN). \!          "daysPerMonth"   - print the array of number of days for
!                               each month. \!          "daysPerYear"    - print the number of days per year
!                             (integer and fractional parts). \!          "monthsPerYear"  - print the number of months per year. \!          "name"           - print the calendar's name. \!          "secondsPerDay"  - print the number of seconds in a day. \!          "secondsPerYear" - print the number of seconds in a year. \!     \item[{[rc]}]
!          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
!     \end{description}
!
!EOP
